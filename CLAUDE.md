...
- **No app scaffold until the coach co-design session.** The repo stays docs-only until then.
...
- [ ] **Example coach Word/Excel week file from William** — importer (locked 17) is built around it; decides deterministic vs Claude-API parse (latter would revise 08's zero-runtime-AI position)
